...
_add(FaultSpec(
    "cap.source_loss", FailureClass.CAPTION_SOURCE_LOSS, FeatureType.CAPTIONS,
    "Caption source loss",
    "The upstream caption source stops emitting cues for one language.",
    "capsrc-{language}", onset="step",
...
_add(FaultSpec(
    "cap.encoder_failure", FailureClass.CAPTION_ENCODER_FAILURE, FeatureType.CAPTIONS,
    "Caption encoder pool failure",
    "Half the encoder pool crash-loops; cues are emitted intermittently.",
    "capenc-pool-a", onset="intermittent",
    ...
    causal_change={"kind": "deployment", "component": "capenc-pool-a",
...
_add(FaultSpec(
    "cap.clock_offset", FailureClass.CAPTION_CLOCK_OFFSET, FeatureType.CAPTIONS,
    "Fixed caption clock offset",
    "A constant timing offset is introduced between programme audio and cues.",
    "capenc-pool-a", onset="step",
    params={"drift_seconds": 3.0},
    default_scope=_scope(),
    expected_slos=("cap.drift",),
    causal_change={"kind": "config", "component": "clock-ptp-primary",
...
_add(FaultSpec(
    "cap.progressive_drift", FailureClass.CAPTION_PROGRESSIVE_DRIFT, FeatureType.CAPTIONS,
    ...
    "capenc-pool-a", onset="ramp", ramp_seconds=180.0,
    params={"drift_seconds": 8.0},
    default_scope=_scope(languages=["en"], territories=WEST_EU, platforms=CTV,
    ...
    remediation=("select_synchronized_standby", "change_clock_source",
                 "switch_caption_encoder_pool"),
    difficulty=0.75,
))

_add(FaultSpec(
    "cap.word_drop", FailureClass.CAPTION_WORD_DROP, FeatureType.CAPTIONS,
    "Caption word drops",
...
_add(FaultSpec(
    "cap.duplicate", FailureClass.CAPTION_DUPLICATE, FeatureType.CAPTIONS,
    "Duplicate caption cues",
    "The packager repeats the previous cue, producing stuttering captions.",
    "packager-main", onset="step",
...
_add(FaultSpec(
    "cap.wrong_language", FailureClass.CAPTION_WRONG_LANGUAGE, FeatureType.CAPTIONS,
    ...
    causal_change={"kind": "routing", "component": "packager-main",
...
_add(FaultSpec(
    "cap.speaker_corruption", FailureClass.CAPTION_SPEAKER_CORRUPTION, FeatureType.CAPTIONS,
...
_add(FaultSpec(
    "cap.reading_speed", FailureClass.CAPTION_READING_SPEED, FeatureType.CAPTIONS,
...
_add(FaultSpec(
    "cap.flicker", FailureClass.CAPTION_FLICKER, FeatureType.CAPTIONS,
    "Caption flicker",
    "Cues are torn down and re-rendered within a second.",
    "pv-ctv-9.4.0", onset="intermittent",
    ...
    causal_change={"kind": "deployment", "component": "pv-ctv-9.4.0",
...
_add(FaultSpec(
    "cap.manifest_omission", FailureClass.CAPTION_MANIFEST_OMISSION, FeatureType.CAPTIONS,
...
_add(FaultSpec(
    "ad.track_omission", FailureClass.AD_TRACK_OMISSION, FeatureType.AUDIO_DESCRIPTION,
...
_add(FaultSpec(
    "ad.silent_segments", FailureClass.AD_SILENT_SEGMENT, FeatureType.AUDIO_DESCRIPTION,
...
_add(FaultSpec(
    "ad.wrong_language", FailureClass.AD_WRONG_LANGUAGE, FeatureType.AUDIO_DESCRIPTION,
    ...
    remediation=("switch_to_approved_alternate_language_source", "republish_corrected_manifest"),
    difficulty=0.4,
))

_add(FaultSpec(
    "ad.timeline_drift", FailureClass.AD_TIMELINE_DRIFT, FeatureType.AUDIO_DESCRIPTION,
    "Description timeline drift",
    "Descriptions land over dialogue instead of in the gaps.",
    "adsrc-en", onset="ramp", ramp_seconds=120.0,
...
_add(FaultSpec(
    "ad.loudness", FailureClass.AD_LOUDNESS_DEFECT, FeatureType.AUDIO_DESCRIPTION,
...
_add(FaultSpec(
    "ad.channel_layout", FailureClass.AD_CHANNEL_LAYOUT, FeatureType.AUDIO_DESCRIPTION,
...
_add(FaultSpec(
    "ad.selection_failure", FailureClass.AD_SELECTION_FAILURE, FeatureType.AUDIO_DESCRIPTION,
...
_add(FaultSpec(
    "alt.track_omission", FailureClass.AD_TRACK_OMISSION, FeatureType.ALTERNATE_AUDIO,
...
_add(FaultSpec(
    "sign.frozen", FailureClass.SIGN_FROZEN_FRAMES, FeatureType.SIGN_LANGUAGE,
    "Frozen interpreter frames",
    "The interpreter feed freezes on a repeated frame.",
    "signsrc-lsf", onset="step",
...
_add(FaultSpec(
    "sign.black", FailureClass.SIGN_BLACK_FRAMES, FeatureType.SIGN_LANGUAGE,
    "Black frames on interpreter feed",
    "The interpreter feed drops to black between segments.",
    "signsrc-lsf", onset="intermittent",
...
_add(FaultSpec(
    "sign.crop", FailureClass.SIGN_CROP_FAILURE, FeatureType.SIGN_LANGUAGE,
    ...
    causal_change={"kind": "config", "component": "signsrc-lsf",
...
_add(FaultSpec(
    "sign.low_framerate", FailureClass.SIGN_LOW_FRAMERATE, FeatureType.SIGN_LANGUAGE,
    "Interpreter feed frame-rate collapse",
    "Encoder saturation drops the interpreter feed to 12 fps, making signs unreadable.",
    "signsrc-lsf", onset="ramp", ramp_seconds=60.0,
    params={"fps": 12.0},
    default_scope=_scope(territories=["FR", "CA"]),
    expected_slos=("sign.framerate",),
    causal_change={"kind": "deployment", "component": "signsrc-lsf",
...
_add(FaultSpec(
    "sign.sync_drift", FailureClass.SIGN_SYNC_DRIFT, FeatureType.SIGN_LANGUAGE,
    "Interpreter feed out of sync",
    "The interpreter feed runs ahead of programme audio.",
    "signsrc-lsf", onset="ramp", ramp_seconds=90.0,
...
_add(FaultSpec(
    "sign.pip_obstruction", FailureClass.SIGN_PIP_OBSTRUCTION, FeatureType.SIGN_LANGUAGE,
    "Picture-in-picture obstruction",
    "The interpreter panel is overlapped by burned-in festival branding.",
    "pv-web-4.12.0", onset="step",
...
_add(FaultSpec(
    "sign.regional_delivery", FailureClass.SIGN_REGIONAL_DELIVERY, FeatureType.SIGN_LANGUAGE,
    "Interpreter feed undelivered in one region",
    "The interpreter rendition is not cached in one CDN region.",
    "region-eu-west", onset="step",
...
_add(FaultSpec(
    "player.keyboard_trap", FailureClass.PLAYER_KEYBOARD_TRAP, FeatureType.ACCESSIBLE_PLAYER,
    ...
    causal_change={"kind": "deployment", "component": "pv-web-4.12.0",
...
_add(FaultSpec(
    "player.missing_name", FailureClass.PLAYER_MISSING_NAME, FeatureType.ACCESSIBLE_PLAYER,
...
_add(FaultSpec(
    "player.focus_loss", FailureClass.PLAYER_FOCUS_LOSS, FeatureType.ACCESSIBLE_PLAYER,
...
_add(FaultSpec(
    "player.inaccessible_error", FailureClass.PLAYER_INACCESSIBLE_ERROR,
...
_add(FaultSpec(
    "player.caption_control", FailureClass.PLAYER_CAPTION_CONTROL,
    FeatureType.ACCESSIBLE_PLAYER,
...
_add(FaultSpec(
    "player.screen_reader", FailureClass.PLAYER_SCREEN_READER, FeatureType.ACCESSIBLE_PLAYER,
...
_add(FaultSpec(
    "player.reduced_motion", FailureClass.PLAYER_REDUCED_MOTION, FeatureType.ACCESSIBLE_PLAYER,
...
_add(FaultSpec(
    "auth.failure", FailureClass.PLAYER_AUTH_FAILURE, FeatureType.ACCESSIBLE_AUTH,
    ...
    causal_change={"kind": "deployment", "component": "auth-svc",
...
_add(FaultSpec(
    "infra.cdn_regional", FailureClass.INFRA_CDN_REGIONAL, FeatureType.CAPTIONS,
    ...
    causal_change={"kind": "provider", "component": "cdn-primary",
...
_add(FaultSpec(
    "infra.packet_loss", FailureClass.INFRA_PACKET_LOSS, FeatureType.CAPTIONS,
    "Transport packet loss",
    "Packet loss on the contribution link causes cue gaps and drift.",
    "cdn-primary", onset="intermittent",
    params={"cue_rate_multiplier": 0.7, "drift_seconds": 1.2, "packet_loss": 0.08,
            "duty_cycle": 0.5, "period_s": 10.0},
...
_add(FaultSpec(
    "infra.gpu_saturation", FailureClass.INFRA_GPU_SATURATION, FeatureType.SIGN_LANGUAGE,
...
_add(FaultSpec(
    "infra.clock_source_change", FailureClass.INFRA_CLOCK_SOURCE_CHANGE, FeatureType.CAPTIONS,
    "Clock source change",
    "A grandmaster failover changes the timing reference for the whole caption chain.",
    "clock-ptp-primary", onset="ramp", ramp_seconds=150.0,
...
_add(FaultSpec(
    "infra.deploy_regression", FailureClass.INFRA_DEPLOY_REGRESSION, FeatureType.ACCESSIBLE_PLAYER,
    "Deployment regression",
    "A player deployment regresses several accessibility behaviours at once.",
    "pv-ctv-9.4.0", onset="step",
    params={"accessible_name_ratio": 0.6, "caption_control_ok": 0.3,
            "screenreader_completion": 0.35, "render_success": 0.5},
    default_scope=_scope(platforms=CTV, player_versions=["ctv-9.4.0"]),
    expected_slos=("player.accessible_name", "player.caption_control",
                   "player.screen_reader", "cap.render_success"),
    causal_change={"kind": "deployment", "component": "pv-ctv-9.4.0",
...
_add(FaultSpec(
    "infra.malformed_manifest", FailureClass.INFRA_MALFORMED_MANIFEST, FeatureType.CAPTIONS,
    "Malformed manifest",
...
_add(FaultSpec(
    "infra.stale_config", FailureClass.INFRA_STALE_CONFIG, FeatureType.CAPTIONS,
    "Stale configuration",
    ...
    causal_change={"kind": "config", "component": "capenc-pool-a",
