// Monotonic alignment kernels for the AccessPulse caption probe.
//
...
//        -o libaccesspulse_align.so align_wavefront.cu
//
// This file is not required to run AccessPulse. With neither the extension nor
...
void accesspulse_align(const int32_t* ref_id, const int32_t* hyp_id,
