...
Selection is automatic and can be pinned with `AP_ALIGN_BACKEND=reference |
...
def active_backend() -> str:
    """The backend that will be used, honouring AP_ALIGN_BACKEND if it is set."""
    requested = os.environ.get("AP_ALIGN_BACKEND", "").strip().lower()
