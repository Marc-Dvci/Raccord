...
CAPTION_SLOS: list[SLODefinition] = [
    SLODefinition(
        "cap.availability", FeatureType.CAPTIONS, "Caption track availability",
        "Fraction of 10 s windows in which the promised caption track is present and non-empty.",
        "accesspulse_caption_track_available_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.999, 0.998, 0.995, 0.99),
    ),
    SLODefinition(
        "cap.first_caption_latency", FeatureType.CAPTIONS, "First caption latency",
        "Seconds from first spoken word to first rendered caption.",
        "accesspulse_caption_first_latency_seconds", "s", Comparator.LOWER_IS_BETTER,
        _tiered(3.0, 4.0, 6.0, 10.0),
    ),
    SLODefinition(
        "cap.drift", FeatureType.CAPTIONS, "End-to-end caption drift",
        "Median signed offset between rendered caption and aligned spoken dialogue.",
        "accesspulse_caption_drift_seconds", "s", Comparator.LOWER_IS_BETTER,
        _tiered(1.5, 2.0, 3.0, 5.0),
    ),
    SLODefinition(
        "cap.omission_rate", FeatureType.CAPTIONS, "Word omission rate",
        "Fraction of spoken tokens with no aligned caption token.",
        "accesspulse_caption_omission_ratio", "ratio", Comparator.LOWER_IS_BETTER,
        _tiered(0.03, 0.05, 0.08, 0.12),
    ),
    SLODefinition(
        "cap.semantic", FeatureType.CAPTIONS, "Semantic preservation",
        "Embedding similarity between caption text and reference transcript.",
        "accesspulse_caption_semantic_score", "score", Comparator.HIGHER_IS_BETTER,
        _tiered(0.90, 0.88, 0.85, 0.80),
    ),
    SLODefinition(
        "cap.speaker_accuracy", FeatureType.CAPTIONS, "Speaker attribution accuracy",
        "Fraction of speaker-change events labelled correctly.",
        "accesspulse_caption_speaker_accuracy_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.95, 0.93, 0.90, 0.85), hard_gate=False,
    ),
    SLODefinition(
        "cap.wrong_language", FeatureType.CAPTIONS, "Wrong-language rate",
        "Fraction of caption cues detected in a language other than the promised one.",
        "accesspulse_caption_wrong_language_ratio", "ratio", Comparator.LOWER_IS_BETTER,
        _tiered(0.001, 0.002, 0.005, 0.01),
    ),
    SLODefinition(
        "cap.duplicate", FeatureType.CAPTIONS, "Duplicate cue rate",
        "Fraction of consecutive identical caption cues.",
        "accesspulse_caption_duplicate_ratio", "ratio", Comparator.LOWER_IS_BETTER,
        _tiered(0.01, 0.02, 0.04, 0.08), hard_gate=False,
    ),
    SLODefinition(
        "cap.reading_speed", FeatureType.CAPTIONS, "Reading-speed compliance",
        "Fraction of cues at or below 20 characters per second.",
        "accesspulse_caption_reading_speed_ok_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.95, 0.93, 0.90, 0.85), hard_gate=False,
    ),
    SLODefinition(
        "cap.flicker", FeatureType.CAPTIONS, "Caption persistence / flicker",
        "Rate of cues displayed for less than 1 s.",
        "accesspulse_caption_flicker_ratio", "ratio", Comparator.LOWER_IS_BETTER,
        _tiered(0.02, 0.03, 0.05, 0.10), hard_gate=False,
    ),
    SLODefinition(
        "cap.render_success", FeatureType.CAPTIONS, "Device render success",
        "Fraction of synthetic player journeys in which captions were observed on screen.",
        "accesspulse_caption_render_success_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.999, 0.998, 0.995, 0.99),
    ),
]
...
AD_SLOS: list[SLODefinition] = [
    SLODefinition(
        "ad.track_present", FeatureType.AUDIO_DESCRIPTION, "Described track declared",
        "Manifest declares the described audio track for the promised language.",
        "accesspulse_ad_track_declared_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(1.0, 1.0, 0.999, 0.995),
    ),
    SLODefinition(
        "ad.audio_present", FeatureType.AUDIO_DESCRIPTION, "Described audio audible",
        "Fraction of description windows containing audio above the silence floor.",
        "accesspulse_ad_audio_present_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.99, 0.98, 0.97, 0.95),
    ),
    SLODefinition(
        "ad.drift", FeatureType.AUDIO_DESCRIPTION, "Description timeline drift",
        "Offset between description events and their target scene intervals.",
        "accesspulse_ad_drift_seconds", "s", Comparator.LOWER_IS_BETTER,
        _tiered(0.8, 1.0, 1.5, 2.5),
    ),
    SLODefinition(
        "ad.loudness", FeatureType.AUDIO_DESCRIPTION, "Loudness within range",
        "Integrated loudness of the described track within -24..-20 LUFS.",
        "accesspulse_ad_loudness_in_range_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.98, 0.97, 0.95, 0.90), hard_gate=False,
    ),
    SLODefinition(
        "ad.language", FeatureType.AUDIO_DESCRIPTION, "Correct description language",
        "Detected language of the described track matches the promise.",
        "accesspulse_ad_language_match_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.999, 0.998, 0.995, 0.99),
    ),
    SLODefinition(
        "ad.selection", FeatureType.AUDIO_DESCRIPTION, "Track selection success",
        "Synthetic journeys able to select the described track from the player menu.",
        "accesspulse_ad_selection_success_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.999, 0.998, 0.995, 0.99),
    ),
]
...
SIGN_SLOS: list[SLODefinition] = [
    SLODefinition(
        "sign.availability", FeatureType.SIGN_LANGUAGE, "Sign feed availability",
        "Fraction of windows in which the interpreter feed is delivering frames.",
        "accesspulse_sign_feed_available_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.99, 0.99, 0.98, 0.95),
    ),
    SLODefinition(
        "sign.frozen", FeatureType.SIGN_LANGUAGE, "Frozen-frame rate",
        "Fraction of frames identical to the previous frame beyond motion tolerance.",
        "accesspulse_sign_frozen_frame_ratio", "ratio", Comparator.LOWER_IS_BETTER,
        _tiered(0.01, 0.02, 0.04, 0.08),
    ),
    SLODefinition(
        "sign.black", FeatureType.SIGN_LANGUAGE, "Black-frame rate",
        "Fraction of frames below the luminance floor.",
        "accesspulse_sign_black_frame_ratio", "ratio", Comparator.LOWER_IS_BETTER,
        _tiered(0.002, 0.005, 0.01, 0.02),
    ),
    SLODefinition(
        "sign.framerate", FeatureType.SIGN_LANGUAGE, "Frame-rate stability",
        "Delivered frames per second on the interpreter feed.",
        "accesspulse_sign_fps", "fps", Comparator.HIGHER_IS_BETTER,
        _tiered(45.0, 45.0, 40.0, 24.0),
    ),
    SLODefinition(
        "sign.visibility", FeatureType.SIGN_LANGUAGE, "Interpreter visibility",
        "Fraction of frames with the interpreter's signing space fully inside the crop.",
        "accesspulse_sign_interpreter_visible_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(0.995, 0.99, 0.98, 0.95),
    ),
    SLODefinition(
        "sign.sync", FeatureType.SIGN_LANGUAGE, "Sign feed A/V sync",
        "Offset between the interpreter feed and programme audio.",
        "accesspulse_sign_sync_drift_seconds", "s", Comparator.LOWER_IS_BETTER,
...
PLAYER_SLOS: list[SLODefinition] = [
    SLODefinition(
        "player.keyboard", FeatureType.ACCESSIBLE_PLAYER, "Keyboard journey completion",
        "Synthetic keyboard-only journeys reaching playback with captions enabled.",
        "accesspulse_player_keyboard_completion_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(1.0, 1.0, 0.99, 0.98),
    ),
    SLODefinition(
        "player.screen_reader", FeatureType.ACCESSIBLE_PLAYER, "Screen-reader completion",
        "Synthetic screen-reader journeys completing the same task.",
        "accesspulse_player_screenreader_completion_ratio", "ratio",
        Comparator.HIGHER_IS_BETTER, _tiered(1.0, 0.99, 0.98, 0.95),
    ),
    SLODefinition(
        "player.accessible_name", FeatureType.ACCESSIBLE_PLAYER, "Accessible name completeness",
        "Fraction of interactive controls exposing a non-empty accessible name.",
        "accesspulse_player_accessible_name_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(1.0, 1.0, 0.99, 0.98),
    ),
    SLODefinition(
        "player.focus_visible", FeatureType.ACCESSIBLE_PLAYER, "Visible focus",
        "Fraction of focusable controls with a visible focus indicator.",
        "accesspulse_player_focus_visible_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(1.0, 1.0, 0.99, 0.98),
    ),
    SLODefinition(
        "player.caption_control", FeatureType.ACCESSIBLE_PLAYER, "Caption control operability",
        "Caption menu discoverable and operable in synthetic journeys.",
        "accesspulse_player_caption_control_ok_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(1.0, 1.0, 0.99, 0.98),
    ),
    SLODefinition(
        "player.reduced_motion", FeatureType.ACCESSIBLE_PLAYER, "Reduced motion respected",
        "Fraction of journeys where prefers-reduced-motion suppressed non-essential motion.",
        "accesspulse_player_reduced_motion_ok_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(1.0, 0.99, 0.98, 0.95), hard_gate=False,
    ),
    SLODefinition(
        "auth.completion", FeatureType.ACCESSIBLE_AUTH, "Accessible authentication completion",
        "Screen-reader + keyboard sign-in journeys completing successfully.",
        "accesspulse_auth_accessible_completion_ratio", "ratio", Comparator.HIGHER_IS_BETTER,
        _tiered(1.0, 0.99, 0.99, 0.98),
    ),
    SLODefinition(
        "purchase.completion", FeatureType.ACCESSIBLE_PURCHASE, "Accessible purchase completion",
        "Screen-reader + keyboard purchase journeys completing successfully.",
        "accesspulse_purchase_accessible_completion_ratio", "ratio",
        Comparator.HIGHER_IS_BETTER, _tiered(1.0, 0.99, 0.98, 0.95),
    ),
]

# ---------------------------------------------------------------------------
# Operational SLOs (about AccessPulse itself)
# ---------------------------------------------------------------------------
...
OPERATIONAL_SLOS: list[OperationalSLO] = [
    OperationalSLO("ops.ttd", "Time to detect", "accesspulse_time_to_detect_seconds", 30.0),
    OperationalSLO("ops.tts", "Time to scope", "accesspulse_time_to_scope_seconds", 45.0),
    OperationalSLO("ops.tte", "Time to evidence complete",
                   "accesspulse_time_to_evidence_seconds", 90.0),
    OperationalSLO("ops.tta", "Time to approved action",
                   "accesspulse_time_to_approval_seconds", 180.0),
    OperationalSLO("ops.ttr", "Time to recovery", "accesspulse_time_to_recovery_seconds", 300.0),
    OperationalSLO("ops.ttc", "Time to public status update",
                   "accesspulse_time_to_communication_seconds", 420.0),
    OperationalSLO("ops.false_closure", "False closure rate",
                   "accesspulse_false_closure_ratio", None, 0.01),
    OperationalSLO("ops.unsafe_action", "Unsafe action rate",
                   "accesspulse_unsafe_action_ratio", None, 0.0),
]
